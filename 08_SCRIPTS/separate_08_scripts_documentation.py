...
File:
    separate_08_scripts_documentation.py

Purpose:
    Move only the previously reviewed documentation files and the three
    unreferenced Research Director builder fragments out of 08_SCRIPTS.
...
Safety:
    ...
    - Creates a transactional quarantine.
    - Runs Project Control validation.
    - Runs Repository Audit System validation.
    - Runs Repository Audit System integration.
    - Rolls back every move if any validation fails.
...
DOCUMENTATION_GROUPS = {
    ...
    "CHANGELOG": (
        "CHANGELOG.md",
        "CHANGELOG_SPRINT2B.md",
        "CHANGELOG_SPRINT2C.md",
        "CHANGELOG_SPRINT3.md",
        "CHANGELOG_SPRINT4A.md",
        "CHANGELOG_SPRINT4B1.md",
    ),
    "MANIFESTS": (
        "MANIFIESTO.md",
        "MANIFIESTO_SPRINT2B.md",
        "MANIFIESTO_SPRINT2C.md",
        "MANIFIESTO_SPRINT3.md",
        "MANIFIESTO_SPRINT4A.md",
        "MANIFIESTO_SPRINT4B1.md",
    ),
    "INSTALLATION": (
        "INSTALACION.md",
        "INSTALACION_SPRINT2C.md",
        "INSTALACION_SPRINT3.md",
        "INSTALACION_SPRINT4A.md",
        "INSTALACION_SPRINT4B1.md",
    ),
}
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Separate reviewed documentation and build artifacts "
            "from 08_SCRIPTS."
        )
    )
...
def build_operations() -> list[MoveOperation]:
    ...
    for group, filenames in DOCUMENTATION_GROUPS.items():
        ...
        for filename in filenames:
            operations.append(
                MoveOperation(
                    ...
                    category=f"DOCUMENTATION/{group}",
                )
            )
...
def print_operations(
    ...
    print("=" * 78)
    print("CLEAN-002 — Documentation and Build Artifact Separation")
    print("=" * 78)
